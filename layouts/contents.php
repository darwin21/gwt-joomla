...
//				$sidebar_right_class = 'large-4 medium-4 columns';
			...
			<div class="<?php echo $sidebar_left_class; ?>">
				<?php if($this->params->get('pstPosition') == 1): ?>
					<?php if($this->params->get('pstVersion') == 0):?>
					...
					<?php else: ?>
					<p><iframe frameborder="0" height="<?php echo $pstHeight; ?>" scrolling="no" src="http://oras.pagasa.dost.gov.ph/widget.shtml" width="260px"></iframe></p>
					<?php endif; ?>
				<?php endif; ?>
